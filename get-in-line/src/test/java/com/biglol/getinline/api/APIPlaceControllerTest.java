...
class APIPlaceControllerTest {
    ...
    @Test
    void givenPlaceAndItsId_whenRequestingPlace_thenReturnsPlaceInStandardResponse()
            throws Exception {
        // Given
        int placeId = 1;
    ...
    @Test
    void givenPlaceAndItsId_whenRequestingPlace_thenReturnsEmptyInStandardResponse()
            throws Exception {
        // Given
        int placeId = 2;
