...
class ApiExceptionHandlerTest {
    ...
    void givenSpringException_whenHandlingApiException_thenReturnsResponseEntity(
    ...
    static Stream<Arguments>
            givenSpringException_whenHandlingApiException_thenReturnsResponseEntity() {
        String msg = "test message";

        return Stream.of(
                //                arguments(new
                // HttpRequestMethodNotSupportedException(HttpMethod.POST.name(), msg),
                // HttpStatus.METHOD_NOT_ALLOWED),
                arguments(
                        new HttpMediaTypeNotSupportedException(msg),
                ...
                arguments(
                        new HttpMessageNotWritableException(msg),
