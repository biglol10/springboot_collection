...
//    @BeforeEach // sut 구현체가 없는 상태라 임시로 이렇게 생성. 아니면 @SpringBootTest, @Autowired로 가능함. 그러나 이 방법은 container가 뜨는데 시간이 좀 걸려서 이렇게 생성자로 일단 씀
//    void setUp() {
...
//    }
    ...
    void giveSearchParams_whenSearchingEvents_thenReturnEvent() {
        ...
        // WHEN
        List<EventDTO> list = sut.getEvents(eventId, eventName, eventStatus, eventStartDatetime, eventEndDatetime);
