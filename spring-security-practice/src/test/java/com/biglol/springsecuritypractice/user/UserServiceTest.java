package com.biglol.springsecuritypractice.user;

import com.biglol.springsecuritypractice.note.Note;
import com.biglol.springsecuritypractice.note.NoteRepository;
...
class UserServiceTest {
    ...
    void findByUser_유저가_게시물조회() {
        ...
        then(note1.getTitle()).isEqualTo("title2"); // 가장 늦게 insert된 데이터가 먼저 나와야 함
